  <div class="row">
    ...
    <?php $jurnal_paper = $this->db->query("SELECT * FROM jurnal_paper WHERE id_jurnal = '$jurnal->id_jurnal' ORDER BY paper_ke ASC")->result(); ?>
    <?php foreach ($jurnal_paper as $jurnal_paper): ?>
      ...
      <h4><a href="<?php echo base_url('paper/').$paper->id_paper ?>"><b><?php echo $paper->judul ?></b></a></h4>
      <div style="padding-left: 1em;">
        <?php  $paper_author = $this->db->query("SELECT * FROM paper_author WHERE id_paper = '$paper->id_paper' ORDER BY author_ke ASC")->result(); ?>
        <p style="margin: 0px">
