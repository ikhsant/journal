...
<p>Please fill all required fields with asterisks (*)</p>
<form action="<?php echo base_url('register_action'); ?>" method="post" style="max-width: 400px">
...
<div class="form-group">
	<label for="address2">Address2 <span class="small">(prefecture, province, state)</span> <?php echo form_error('address2') ?></label>
...
<div class="form-group">
	<label for="varchar">Name of Institution/Organization/ Company <?php echo form_error('institution') ?></label>
...
<div class="form-group">
	...
	<select class="form-control" name="category" id="category" placeholder="Category" value="<?php echo $category; ?>" />
		<option>Choose Category</option>
		<option value="organization">Private Organization/Company</option>
...
<hr>
<h2>Authors Fees:</h2>
<p>On Line publication in this Journal is free. Postal fees are needed for printed version.</p>