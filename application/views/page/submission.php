	...
	<div class="panel panel-default">
		...
		<form method="post" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="panel-footer text-center">
				...
				<a href="<?php echo base_url('paper/submited') ?>" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Cancel</a>
			</div>
		</form>
	</div>
	<?php else: ?>
		<div class="alert alert-info">
			<h3><span class="glyphicon glyphicon-info-sign"></span> Paper Submission is Close</h3>
		</div>
		<a href="<?php echo base_url('paper/submited') ?>" class="btn btn-info"><span class="glyphicon glyphicon-arrow-left"></span> BACK</a>
	<?php endif ?>
